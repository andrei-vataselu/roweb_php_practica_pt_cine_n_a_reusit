...
```
cd laravel-blog
Redenumeste .env.example in .env

Exemplul meu de .env
 APP_NAME="Laravel Blog Tutorial"
APP_ENV=local
APP_KEY=base64:tn8VyURQh2dB4dkSo+4y5Aii83gXh6a7NbbuY9aIKe4=
APP_DEBUG=true
...
- Daca ai probleme cel mai probil sunt si cu capu nu doar cu codu
